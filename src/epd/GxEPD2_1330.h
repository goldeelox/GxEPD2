...
#ifndef _GxEPD2_1330_H_
#define _GxEPD2_1330_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_1330 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::XXXX; // GxEPD2::GDEH075Z90;
    ...
    static const uint16_t full_refresh_time = 4200; // ms, e.g. 22780001us
    static const uint16_t partial_refresh_time = 4200; // ms, e.g. 22780001us
